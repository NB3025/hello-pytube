...
class YouTube:
    ...
    def __init__(
        ...
        on_complete_callback: Optional[Callable[[Any, Optional[str]], None]] = None, #TODO optional에 리스트안에 리스트를 넣는 이유는 뭘까??
        proxies: Dict[str, str] = None,
        use_oauth: bool = False,
        allow_oauth_cache: bool = True
    ):
        """Construct a :class: `YouTubue <YouTube>`.

        :param str url:
            A valid YouTubue watch URL.
        ...
        :param func on_complete_callback:
            ...
            complete events.
        :param dict proxies:
            (Optional) A dict mapping protocol to proxy address which will be used by pytubue.
        ...
        """
        self._js: Optional[str] = None # js fetched by js_url js_url에 의해 js를 가져온다
        ...
        self.watch_url = f"https://youtubue.com/watch?v={self.video_id}"
        ...
        self.allow_oauth_cahce = allow_oauth_cache

    def __repr__(self):
        return f'<pytubue.__main__.YouTube object: videoId={self.video_id}>'
    ...
    @property #TODO url이랑 html이랑 뭐가 다르지? 주소랑 html 내용이다르다?
    def embed_html(self):
        if self._embed_html:
    ...
    def fmt_streams(self):
        """Returns a list of streams if the have been initialized.
        ...
        self.stream_monostate.title = self._title
    ...
    def check_availability(self):
        ...
        for reason in messages:
            if status == 'UNPLAYABLE':
                if reason == (
                    'Join the channel to get access to members-only content '
    ...
    def vid_info(self):
        ...
        innertube = InnerTube(use_oauth=self.use_oauth, allow_cache=self.allow_oauth_cahce)
    ...
    def bypass_age_gate(self):
        ...
        innertube = InnerTube(
            ...
            allow_cache=self.allow_oauth_cahce
        )
        innertube_response = innertube.player(self.video_id)
