...
combined). This was referred to as ``Video`` is the legacy pytube version, but
...
class Stream:
    ...
    def __init__(
        ...
        #  (Borg pattern). 싱글톤과 유사하지만 상태(state)를 공유함
    ...
    def includes_audio_track(self) -> bool:
        ...
        :rtype: bool
        """
        return self.is_progressive or self.tpye == "audio"
    ...
    def __repr__(self) -> str:
        ...
        """
        parts = ['itag="{s.itag}"', 'mime_type="{s.mime_type}"'] #TODO s가 뭐지?
